        ...
        {step === "schema" && schema && (
          <div className="space-y-4 animate-fade-in">
            ...
            {schema.variant_properties && schema.variant_properties.length > 0 && (
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                <div className="px-4 py-3 bg-slate-50 dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600 flex items-center gap-2">
                  <Box className="w-4 h-4 text-green-700 dark:text-green-500" />
                ...
                <div className="p-3 grid grid-cols-2 gap-2">
                  {schema.variant_properties.map((prop) => (
                    <div key={prop.name} className="flex items-center gap-2 p-2 rounded-lg bg-slate-50 dark:bg-slate-700/50">
                      <span className="px-2 py-0.5 rounded bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-500 text-xs font-mono">
                        {prop.name}
                      </span>
            ...
            {schema.category_dimensions && schema.category_dimensions.length > 0 && (
              <div className="border border-slate-200 dark:border-slate-700 rounded-xl overflow-hidden">
                <div className="px-4 py-3 bg-slate-50 dark:bg-slate-700 border-b border-slate-200 dark:border-slate-600 flex items-center gap-2">
                  <Link2 className="w-4 h-4 text-green-700 dark:text-green-500" />
                  <span className="text-sm font-semibold text-slate-700 dark:text-slate-300">
                ...
                <div className="divide-y divide-slate-100 dark:divide-slate-700">
                  {schema.category_dimensions.map((cat) => (
                    <div key={cat.label} className="p-3">
                      <div className="flex items-center gap-2 mb-2">
                        <span className="px-2 py-1 rounded-lg bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-500 text-xs font-mono font-medium">
                          {cat.label}
                        </span>
          ...
          <div className="space-y-4 animate-fade-in">
            ...
            <div className="grid grid-cols-2 sm:grid-cols-5 gap-3">
              <div className="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-center">
                <div className="text-2xl font-bold text-green-800 dark:text-green-500">
                  {result.counts.product_variants}
                </div>
                <div className="text-xs text-green-700 dark:text-green-500">Variants</div>
              </div>
              <div className="p-4 rounded-xl bg-green-50 dark:bg-green-900/20 border border-green-200 dark:border-green-800 text-center">
                <div className="text-2xl font-bold text-green-800 dark:text-green-500">
                  {result.counts.categories}
                </div>
                <div className="text-xs text-green-700 dark:text-green-500">Categories</div>
              </div>
                ...
                <ScrollArea className="h-64">
                  <div className="p-3 space-y-2">
                    {result.extracted.products.map((product, i) => (
                      ...
                      >
                        <div className="flex items-center gap-2 mb-2">
                          <span className="px-2 py-0.5 rounded bg-green-100 dark:bg-green-900/40 text-green-800 dark:text-green-500 text-xs font-mono font-medium">
                            {product.id}
                          </span>
                        ...
                        {product.categories && product.categories.length > 0 && (
                          <div className="flex flex-wrap gap-1">
                            {product.categories.map((cat, j) => (
                              <span key={j} className="px-1.5 py-0.5 rounded bg-green-50 dark:bg-green-900/30 text-green-800 dark:text-green-500 text-[10px]">
                                {cat.label}: {cat.value}
                              </span>
                            ))}
                          </div>

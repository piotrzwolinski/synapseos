  ...
  return (
    <Card
      className={cn(
        ...
        isCritical
          ? "border-red-300 bg-gradient-to-br from-red-50/80 to-rose-50/50"
          : "border-amber-300 bg-gradient-to-br from-amber-50/80 to-orange-50/50"
      )}
    >
      {/* Accent bar */}
      <div
      ...
      <Separator
        className={isCritical ? "bg-red-200/50" : "bg-amber-200/50"}
      />

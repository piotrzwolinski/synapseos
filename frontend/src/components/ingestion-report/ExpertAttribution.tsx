      ...
      <div className="p-5">
        <div className="flex flex-col items-center text-center">
          ...
          <div className="relative mb-3">
            ...
            <div className="absolute -bottom-1 -right-1 w-6 h-6 rounded-full bg-amber-400 flex items-center justify-center shadow-md border-2 border-white">
          ...
          <p className="text-xs text-slate-500 mb-4">{expert.role}</p>

          {/* Contribution */}
          <div className="w-full p-3 rounded-lg bg-slate-50 border border-slate-100">

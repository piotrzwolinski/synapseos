    ...
    <Card className="overflow-hidden border border-slate-200 shadow-md">
      ...
      <div className="grid grid-cols-2 divide-x divide-slate-200">
        ...
        <div className="p-4 bg-slate-100/50 relative">
          ...
          <div className="relative">
            ...
            <div className="p-3 rounded-lg bg-white/60 border border-slate-200">
              <p className="text-sm text-slate-500 line-through decoration-red-400/50 leading-relaxed opacity-70">
        ...
        <div className="p-4 bg-emerald-50/30 relative">
          ...
          <div className="p-3 rounded-lg bg-white border-2 border-emerald-500 shadow-sm shadow-emerald-500/10">
            <div className="flex items-start gap-2">

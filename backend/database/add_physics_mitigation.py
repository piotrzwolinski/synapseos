...
def create_environment_nodes(graph):
...
def create_feature_nodes(graph):
...
def create_physics_relationships(graph):
...
def link_products_to_features(graph):
...
def verify_physics_model(graph):
    ...
    """)
    for record in result_to_dicts(result3):
...
def main():
    ...
    try:
        ...
        create_environment_nodes(graph)
        create_risk_nodes(graph)
        create_feature_nodes(graph)
        create_physics_relationships(graph)
        link_products_to_features(graph)
        verify_physics_model(graph)
